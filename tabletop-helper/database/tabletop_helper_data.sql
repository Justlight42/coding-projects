...
VALUES
    ('JustinG', '$2a$10$tmxuYYg1f5T0eXsTPlq/V.DJUKmRHyFbJ.o.liI1T35TFbjs2xiem','ROLE_ADMIN'),
...
VALUES
  ...
  (1, 3, NULL, 30),          -- ongoing session, if 2 = SURVIVAL or another mode
  (0, 4, '2025-06-07 12:00:00', 50),
  (1, 5, '2025-06-07 12:30:00', 40),
  (0, 6, NULL, 55),          -- ongoing session
  (0, 7, '2025-06-07 13:15:00', 65),
  (1, 8, NULL, 35),          -- ongoing session
  (1, 9, '2025-06-07 14:00:00', 70),
  (0,10, '2025-06-07 14:30:00', 55),
  (1, 1, NULL, 45),          -- ongoing session
  (0, 2, '2025-06-07 15:00:00', 60),
  (0, 3, '2025-06-07 15:30:00', 50),
  (1, 4, NULL, 40),          -- ongoing session
  (0, 5, '2025-06-07 16:00:00', 75);
